...
void EditorLayer::OnUpdate(const Timestep ts) {
    ...
    glm::mat4 new_model = glm::scale(model, scale);
    ...
    m_ShadowMapping->SetMat4("u_Model", new_model);
    ...
    m_BasicShader->SetMat4("model", glm::mat4(1.f));
    m_BasicShader->SetMat4("model", translateMat * rotationMat);
    m_LightModel->Draw(*m_BasicShader);
